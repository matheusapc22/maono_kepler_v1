...
import type { KeplerCommandResult } from "../../engine-adapter";
...
export default function MaonoLayerPanel() {
  ...
  const { datasets, error, filters, isLoading, layers, selectedLayerId } =
    useKeplerState();
  ...
  const canRename = Boolean(
    capabilities?.editLayers || capabilities?.editLayerStyle,
  );

...
test("runtime composto monta legado e cobertura persistente sobre a mesma Working Copy", () => {
  assert.match(runtimeComposition, /coordinateViewerWorkingCopyStore/);
  assert.match(runtimeComposition, /const coordinatedStore = coordinateViewerWorkingCopyStore\(props\.store\)/);
